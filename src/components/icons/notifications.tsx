export function NotificationIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M15.9964 18.8199C15.9964 20.6499 14.4964 22.1499 12.6664 22.1499C11.7564 22.1499 10.9164 21.7699 10.3164 21.1699C9.71643 20.5699 9.33643 19.7299 9.33643 18.8199"
        stroke="currentColor"
        strokeOpacity="0.5"
        strokeWidth="1.5"
        strokeMiterlimit="10"
